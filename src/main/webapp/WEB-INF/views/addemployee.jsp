...
<form>
	<table>
		...
		<tr>
			<td>Salary:</td>
			<td><input type="text" id="salary" maxlength="10"
				data-rule-maxlength="10"
				oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
				name="salary" /></td>
		</tr>
	...
	<input type="text" style="display: none;" name="taskInstanceId"
		id="taskInstanceId"> <input type="button" value="Save"
		id="saveButton" /> <input class="clearButton"  id="clearNew"
...
/* search employee based on employee no and empoyee name*/
